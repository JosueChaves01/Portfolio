...
import {
  THEMES, SETTINGS, QUICK_ACTIONS, KEYBOARD_SHORTCUTS_LIST,
  ...
  return (
    <div className={styles.panel}>
      <section className={styles.section}>
        <h3 className={styles.sectionTitle}>{SETTINGS.SECTION_THEME}</h3>
      ...
      <section className={styles.section}>
        <h3 className={styles.sectionTitle}>{SETTINGS.SECTION_QUICK_ACTIONS}</h3>
      ...
      <section className={styles.section}>
        <h3 className={styles.sectionTitle}>{SETTINGS.SECTION_SHORTCUTS}</h3>
      ...
      <footer className={styles.footer}>
        <p className={styles.footerText}>{SETTINGS.FOOTER_VERSION}</p>
        <p className={styles.footerText}>{SETTINGS.FOOTER_CREDIT}</p>
      </footer>
    </div>
  );
}
